...
Future<void> _pumpScreen(
  ...
  final extraction = SymptomExtractionService(
    client: MockClient(
      (_) async => _geminiJsonResponse(extractionFields ?? const {}),
    ),
  );
...
void main() {
  ...
  testWidgets(
    ...
    'editable controls, and never trigger submission',
    (tester) async {
      ...
      await tester.enterText(
        ...
        'I feel hot, my pain is 7 out of 10',
      );
      await tester.pump();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pump(const Duration(milliseconds: 100));
      expect(
        find.textContaining("Voice input isn't available"),
        findsOneWidget,
      );
  ...
  testWidgets('Stage 1 payload is byte-identical whether fields were typed or '
